                  ...
                  <div class="bs-stepper-content">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" autocomplete="off" class="form-control" name="keterangan" placeholder="Tanggal Pemberkatan">
                            </div>
                          </div>
                          <div class="col-sm-6">
                    ...
                    <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" required autocomplete="off" class="form-control" name="nama_gereja_laki" id="exampleInputText" placeholder="ID Gereja">
                      </div>
                      <div class="form-group">
